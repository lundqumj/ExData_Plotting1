...
#PLOT 3
plot(data$zTime,data$Voltage,type="l",xlab="datetime", ylab="Voltage")

#PLOT 4
plot(data$zTime,data$Global_reactive_power,type="l",xlab="datetime", ylab="Global_reactive_power")
